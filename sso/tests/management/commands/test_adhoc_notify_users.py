...
def test_adhoc_notify_command_with_multiple_users(
    user,
...
@pytest.mark.django_db
def test_adhoc_notify_command_for_active_users(user, mock_adhoc_notification_client):
    User = get_user_model()  # noqa
    total_users = User.objects.count()
...
@pytest.mark.django_db
def test_adhoc_notify_command_for_valid_response(inactive_user, mock_adhoc_notification_client):
    User = get_user_model()  # noqa
    total_users = User.objects.count()
...
@pytest.mark.django_db
def test_adhoc_notify_command_for_invalid_api_response(inactive_user, mock_adhoc_notification_bad_client):

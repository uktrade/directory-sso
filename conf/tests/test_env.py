        ...
        'postgres': [
            {
                ...
                'instance_guid': '1234',
                'instance_name': 'directory-sso-db',
                'label': 'postgres',
                'name': 'directory-sso-db',
                'plan': 'medium-ha',
                'provider': None,
        ...
        'redis': [
            {
                ...
                'instance_guid': '4567',
                'instance_name': 'directory-sso-redis-small',
                'label': 'redis',
                'name': 'directory-sso-redis-small-ha-6',
                'plan': 'small-ha',
                'provider': None,
                'syslog_drain_url': None,
...
def vcap_application():
    data = {
        ...
        'application_name': 'directory-sso',
...
def test_gov_paas_environment(vcap_application, vcap_services):
    ...
    assert environment_reader.env.vcap_application.name == 'directory-sso'
